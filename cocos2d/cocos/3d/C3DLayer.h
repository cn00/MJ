...
public:
    ...
    // optional
    virtual void onTouchesBegan(	const std::vector<Touch*>& pTouches, cocos2d::Event *pEvent){};
    virtual void onTouchesMoved(	const std::vector<Touch*>& pTouches, cocos2d::Event *pEvent){};
    virtual void onTouchesEnded(	const std::vector<Touch*>& pTouches, cocos2d::Event *pEvent){};
    virtual void onTouchesCancelled(const std::vector<Touch*>& pTouches, cocos2d::Event *pEvent){};
    ...
    virtual void draw(Renderer *renderer, const kmMat4 &transform, bool transformUpdated);//render the 3d contents
